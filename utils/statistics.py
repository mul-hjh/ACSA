...
if __name__ == "__main__":
    root = '/workspace2/junhua/Deep-Cross-Modal-Projection-Learning-for-Image-Text-Matching-master/datasets/processed_data/train_sort.pkl'
    data0 = count_captions(root)
    print("captions in each image: " + str(data0))
    visualize(data0)
    data1 = count_images(root)
    print("images in each id: " + str(data1))
    visualize(data1)
